...
public class MessageConductor {
    ...
    public void steerMessage(String payload, String topic) throws JSONException {
        ...
        if (topic.contains(Constants.COMMANDRECEIVE_EVENT)) {
            Log.d(TAG, "Commandreceive Event");
            int r = 104;
            int g = 109;
            int b = 115;
            double a = 1.0;
            String h = d.getString("h");
            ...
            actionIntent.putExtra(Constants.INTENT_DATA, Constants.COMMANDRECEIVE_EVENT);
