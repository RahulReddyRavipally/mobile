...
public class LocationUtils implements LocationListener {
    ...
    public void connect() {
        ...
        if (!locationManager.isProviderEnabled(locationProvider)) {
            ...
            if (isGPSEnabled) {
                locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, Constants.LOCATION_MIN_TIME, Constants.LOCATION_MIN_DISTANCE, this);
                    Log.d("GPS Enabled", "GPS Enabled");
                    if (locationManager != null) {
                        app.setCurrentLocation(locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER));
